...
<div class="container">
    ...
    <div class="col-md-10">
        ...
        <ul class="nav nav-tabs">
            ...
            <li><a href="search.jsp">用户搜索</a></li>
            <li class="active"><a>用户添加</a></li>
        </ul>
        <form action="/userAdd" method="post" class="form-horizontal" role="form" style="padding: 40px 0 0 0">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea class="form-control from-textarea" id="self" name="introduction" placeholder="请输入简介" style="height: 100px"></textarea>
                </div>
            </div>
            <div class="form-group">
